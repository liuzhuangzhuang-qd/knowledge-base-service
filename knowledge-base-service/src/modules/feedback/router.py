...
@router.get("/api/sessions/getList", response_model=list[SessionOut])
...
@router.get("/api/sessions/messages/getList", response_model=list[MessageOut])
def list_messages(
...
@router.post("/api/messages/feedback/create")
def create_feedback(
    message_id: int,
    payload: FeedbackIn,
